      ...
      <div class="row">
        ...
        <b-form-group :label="windowWidth >= 992 ? '&nbsp;' : ''" class="col-lg-3 col-12">
          <button class="btn btn-atlas1 col-12" @click="searchCollapse = !searchCollapse">
            <i
              class="fa"
              :class="!searchCollapse ? 'fa-arrow-down' : 'fa-arrow-up'"
              aria-hidden="true"
            ></i> Pesquisa avançada
          </button>
        </b-form-group>
                ...
                <b-form-select v-model="classroom">
                  ...
                  <template v-if="classrooms.length">
                    ...
                    <optgroup label="Piso 0" v-if="classroomFloorCondition('Piso 0')">
                      ...
                      <option
                        value="B102"
                        v-if="classrooms.some(classroom => classroom === 'B102')"
                      >B102</option>
                      <option
                        value="B103A"
                        v-if="classrooms.some(classroom => classroom === 'B103A')"
                      >B103A</option>
                      <option
                        value="B103B"
                        v-if="classrooms.some(classroom => classroom === 'B103B')"
                      >B103B</option>
                      <option
                        value="B104"
                        v-if="classrooms.some(classroom => classroom === 'B104')"
                      >B104</option>
                      <option
                        value="B105"
                        v-if="classrooms.some(classroom => classroom === 'B105')"
                      >B105</option>
                      <option
                        value="B106"
                        v-if="classrooms.some(classroom => classroom === 'B106')"
                      >B106</option>
                      <option
                        value="B107"
                        v-if="classrooms.some(classroom => classroom === 'B107')"
                      >B107</option>
                      <option
                        value="B108"
                        v-if="classrooms.some(classroom => classroom === 'B108')"
                      >B108</option>
                      <option
                        value="B109"
                        v-if="classrooms.some(classroom => classroom === 'B109')"
                      >B109</option>
                      <option
                        value="B110"
                        v-if="classrooms.some(classroom => classroom === 'B110')"
                      >B110</option>
                      <option
                        value="B111"
                        v-if="classrooms.some(classroom => classroom === 'B111')"
                      >B111</option>
                      <option
                        value="B112"
                        v-if="classrooms.some(classroom => classroom === 'B112')"
                      >B112</option>
                    </optgroup>
                    <optgroup label="Piso 1" v-if="classroomFloorCondition('Piso 1')">
                      <option
                        value="B201"
                        v-if="classrooms.some(classroom => classroom === 'B201')"
                      >B201</option>
                      <option
                        value="B202"
                        v-if="classrooms.some(classroom => classroom === 'B202')"
                      >B202</option>
                      <option
                        value="B203"
                        v-if="classrooms.some(classroom => classroom === 'B203')"
                      >B203</option>
                      <option
                        value="B204"
                        v-if="classrooms.some(classroom => classroom === 'B204')"
                      >B204</option>
                      <option
                        value="B205"
                        v-if="classrooms.some(classroom => classroom === 'B205')"
                      >B205</option>
                      <option
                        value="B206"
                        v-if="classrooms.some(classroom => classroom === 'B206')"
                      >B206</option>
                      <option
                        value="B207"
                        v-if="classrooms.some(classroom => classroom === 'B207')"
                      >B207</option>
                      <option
                        value="B208"
                        v-if="classrooms.some(classroom => classroom === 'B208')"
                      >B208</option>
                      <option
                        value="B209"
                        v-if="classrooms.some(classroom => classroom === 'B209')"
                      >B209</option>
                      <option
                        value="B210"
                        v-if="classrooms.some(classroom => classroom === 'B210')"
                      >B210</option>
                      <option
                        value="B211"
                        v-if="classrooms.some(classroom => classroom === 'B211')"
                      >B211</option>
                      <option
                        value="B212"
                        v-if="classrooms.some(classroom => classroom === 'B212')"
                      >B212</option>
                    </optgroup>
                    <optgroup label="Piso 2" v-if="classroomFloorCondition('Piso 2')">
                      <option
                        value="B301"
                        v-if="classrooms.some(classroom => classroom === 'B301')"
                      >B301</option>
                      <option
                        value="B302"
                        v-if="classrooms.some(classroom => classroom === 'B302')"
                      >B302</option>
                      <option
                        value="B303"
                        v-if="classrooms.some(classroom => classroom === 'B303')"
                      >B303</option>
                      <option
                        value="B304"
                        v-if="classrooms.some(classroom => classroom === 'B304')"
                      >B304</option>
                      <option
                        value="B305"
                        v-if="classrooms.some(classroom => classroom === 'B305')"
                      >B305</option>
                      <option
                        value="B306"
                        v-if="classrooms.some(classroom => classroom === 'B306')"
                      >B306</option>
                      <option
                        value="B307"
                        v-if="classrooms.some(classroom => classroom === 'B307')"
                      >B307</option>
                      <option
                        value="B308"
                        v-if="classrooms.some(classroom => classroom === 'B308')"
                      >B308</option>
                      <option
                        value="B309"
                        v-if="classrooms.some(classroom => classroom === 'B309')"
                      >B309</option>
                      <option
                        value="B310"
                        v-if="classrooms.some(classroom => classroom === 'B310')"
                      >B310</option>
                      <option
                        value="B311"
                        v-if="classrooms.some(classroom => classroom === 'B311')"
                      >B311</option>
                      <option
                        value="B312"
                        v-if="classrooms.some(classroom => classroom === 'B312')"
                      >B312</option>
                    </optgroup>
                  </template>
                </b-form-select>
        ...
        if (this.selectedTags.length) {
          result =
            this.selectedTags.every(selectedTag =>
              event.tags.some(eventTag => selectedTag === eventTag)
            ) && result;
        }
      ...
      if (!this.filtering) {
        this.totalPages =
          this.getEndedEvents.length <= this.endedEventsPerPage
            ? 1
            : Math.floor(this.getEndedEvents.length / this.endedEventsPerPage) +
              1;
      } else {
        this.totalPages =
