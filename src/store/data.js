export default {
    users: [
        ...
        { id: 2, profileId: 1, name: "Atlas", username: "atlas", password: "12345", email: "atlas@atlas.pt", picture: "https://artscimedia.case.edu/wp-content/uploads/sites/79/2016/12/14205134/no-user-image.gif", gender: 1, idInstitution: 1 }
    ],
    institutions: [
        { id: 1, name: "ESMAD" },
        { id: 2, name: "ESHT" }
